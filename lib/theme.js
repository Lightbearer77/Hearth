...
// On Android, react-native maps font weights to system fonts.
// We use the system default for now; a session 4 task is loading
// Cormorant Garamond and Spectral via expo-font.
export const FONTS = {
  display: 'serif',
  body:    'serif',
  mono:    'monospace',
